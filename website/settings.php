...
$login_password = "d45HKmyHkQkNPGNoZxz7Dwz7i";
// Do you want to use hCaptcha for login?
$login_hcaptcha = false;
$login_hcaptcha_sitekey = "Site Key Here";
$login_hcaptcha_privatekey = "Private Key Here";

//Choose default theme
$default_theme = "dark";

//How many rows can be shown on the same time?
$data_limit = 10;

//Discord server link. Example: "https://discord.gg/hUNymXX" or null
$discord_link = "Your Link Here";

//Server store link. Example: "http://store.rabbitcraft.net" or null
$store_link = "Your Link Here";
